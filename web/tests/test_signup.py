...
class SignupTest(unittest.TestCase):
    ...
    def test_signup_successfully(self):
        ...
        new_password = "123456"
        self.signupPage.SignUp("Hung","Nguyen",new_email,new_password,new_password)
    ...
    def test_signup_fail_confirm_pass(self):
        ...
        new_email = f"user{int(time.time())}@gmail.com"
        new_password = "123456"
        self.signupPage.SignUp("Hung","Nguyen",new_email,new_password,"123678")
    ...
    def test_signup_fail_all(self):
        ...
        self.signupPage.verify_error_signup("Vui lòng nhập họ của bạn!")
